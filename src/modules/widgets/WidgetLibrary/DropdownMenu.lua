...
function DropdownMenu:GetButton()
...
function DropdownMenu:RemoveAll()
    for i,v in pairs(self._buttonArray) do
		self:RemoveSelection(i)
	end
end
...
function DropdownMenu:SetValueChangedFunction(vcf)
